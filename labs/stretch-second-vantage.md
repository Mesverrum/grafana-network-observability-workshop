...
← Previous: [Lab 4 — Explore](04-explore.md) or [Lab 2 — Synthetics](02-synthetics.md)

Optional. Skip unless chat says to. This is **not** the Lab 5 incident.
...
Back: [Lab 4 — Explore](04-explore.md) · Next if the room is ready: [Lab 5 — Troubleshoot](05-troubleshoot.md) →
